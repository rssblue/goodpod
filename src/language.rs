    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        if s.starts_with("de") {
            return match LanguageGerman::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid German language code", s)),
            };
        }
        ...
        if s.starts_with("en") {
            return match LanguageEnglish::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid English language code", s)),
            };
        }
        ...
        if s.starts_with("es") {
            return match LanguageSpanish::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid Spanish language code", s)),
            };
        }
        ...
        if s.starts_with("fr") {
            return match LanguageFrench::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid French language code", s)),
            };
        }
        ...
        if s.starts_with("it") {
            return match LanguageItalian::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid Italian language code", s)),
            };
        }
        ...
        if s.starts_with("nl") {
            return match LanguageDutch::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid Dutch language code", s)),
            };
        }
        ...
        if s.starts_with("pt") {
            return match LanguagePortugese::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid Portuguese language code", s)),
            };
        }
        ...
        if s.starts_with("ro") {
            return match LanguageRomanian::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid Romanian language code", s)),
            };
        }
        ...
        if s.starts_with("ru") {
            return match LanguageRussian::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid Russian language code", s)),
            };
        }
        ...
        if s.starts_with("sv") {
            return match LanguageSwedish::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid Swedish language code", s)),
            };
        }
        ...
        if s.starts_with("zh") {
            return match LanguageChinese::from_str(s.as_str()) {
                ...
                Err(_) => Err(format!("`{}` is not a valid Chinese language code", s)),
            };
        }
        ...
        Err(format!("`{}` is not a valid language code", s))
    }
}
...
mod tests {
    ...
    fn test_from_str() {
        ...
        pretty_assertions::assert_eq!(Language::from_str("cs").unwrap(), Language::Czech);
        pretty_assertions::assert_eq!(
            Language::from_str("en").unwrap(),
            Language::English(LanguageEnglish::Default)
        );
        pretty_assertions::assert_eq!(
            Language::from_str("en-gb").unwrap(),
            Language::English(LanguageEnglish::UnitedKingdom)
        );
        pretty_assertions::assert_eq!(
            Language::from_str("en-aa").unwrap_err(),
            "`en-aa` is not a valid English language code"
        );
    }
}
